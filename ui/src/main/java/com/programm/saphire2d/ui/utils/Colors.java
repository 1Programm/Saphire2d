package com.programm.saphire2d.ui.utils;
...
public class Colors {
    ...
    public static final Vector4f LIGHT_GRAY = new Vector4f(0.75f, 0.75f, 0.75f, 1.0f);
    public static final Vector4f LIGHTER_GRAY = new Vector4f(0.86f, 0.86f, 0.86f, 1.0f);
